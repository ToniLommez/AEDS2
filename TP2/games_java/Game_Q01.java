...
class Games {
     ...
     */
    Games(int app_id, String name, String release_date, String owner, int age, float price, int dlcs, String[] languages,
     ...
     * E' importante entender que mesmo padronizado muitos jogos a serem cadastrados chegam com erros de
     * entrada e por isso precisam de tratamento especial, como por exemplo
     * jogos onde o dia de lancamento nao e' conhecido, jogos que possum virgula no nome e etc...
     * @param steam String com padrao de saida da Steam contendo todos os dados tabulados por ',' e '[]'
     */
