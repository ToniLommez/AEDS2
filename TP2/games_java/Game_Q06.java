...
public class Game {
    ...
    public static void main(String[] args) throws IOException {
        ...
        pilhaGames pilha = new pilhaGames(100);
        try {
            ...
            for (int i = 0; i < numEntrada; i++) {
                ...
                if (temp.equals("I")) {
                    ...
                    pilha.insertEnd(procurarGame(games, pos));
                } else if (temp.equals("R")) {
                    MyIO.print("(R) ");
                    MyIO.print(pilha.removeEnd().get_name());
                    MyIO.print("\n");
                }
            }
            pilha.printall();
