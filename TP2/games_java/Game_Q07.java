...
class filaCircularGames {
    ...
    filaCircularGames(int total) {
        this.games = new Games[total + 1];
        this.primeiro = 0;
        this.ultimo = 0;
        this.i = 0;
    }
    ...
    public Games remove() {
        if (primeiro == ultimo) {
            return games[primeiro];
        }

        Games resp = games[primeiro];
...
public class Game {
    ...
    public static void main(String[] args) throws IOException {
        ...
        filaCircularGames filaCircular = new filaCircularGames(5);
        try {
            ...
            for (int i = 0; i < numEntrada; i++) {
                ...
                if (temp.equals("I")) {
                    ...
                    filaCircular.insert(procurarGame(games, pos));
                } else if (temp.equals("R")) {
                    System.out.printf("(R) %s\n", filaCircular.remove().get_name());
                }
            }
            filaCircular.printall();
        } catch (Exception e) {
