...
public class Game_selecao {
    ...
    public static void matriculaSelecao(int comparacoes, int movimentacoes, long tempo) {
        try {
            Formatter file = new Formatter("matricula_selecao.txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // criando log
            matriculaSelecao(lista.comparacoes, lista.movimentacoes, total_time);
            // printando
            for (int i = 0; i < numEntrada; i++) {
