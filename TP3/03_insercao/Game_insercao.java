...
class ListaGames {
    ...
    // esta funcao serve para contar as comparacoes entre elementos do array do insertion_sort
    public boolean eMaior(int j, Games temp) {
        this.comparacoes += 1;
...
public class Game_insercao {
    ...
    public static void matriculaInsercao(int comparacoes, int movimentacoes, long tempo) {
        try {
            Formatter file = new Formatter("matricula_insercao.txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // criando log
            matriculaInsercao(lista.comparacoes, lista.movimentacoes, total_time);
            // printando
            for (int i = 0; i < numEntrada; i++) {
