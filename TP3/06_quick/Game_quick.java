...
public class Game_quick {
    ...
    public static void matriculaQuicksort(int comparacoes, int movimentacoes, long tempo) {
        try {
            Formatter file = new Formatter("matricula_quicksort.txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // gravando log
            matriculaQuicksort(lista.comparacoes, lista.movimentacoes, total_time);
            // printando
            for (int i = 0; i < numEntrada; i++) {
