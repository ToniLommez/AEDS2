...
public class Game_bubble {
    ...
    public static void matriculaBolha(int comparacoes, int movimentacoes, long tempo) {
        try {
            Formatter file = new Formatter("matricula_bolha.txt");
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            // criando log
            matriculaBolha(lista.comparacoes, lista.movimentacoes, total_time);
            // printando
            for (int i = 0; i < numEntrada; i++) {
