        ...
        try {
            ...
            for (int i = 0; i < numEntrada; i++) {
                ...
                if (temp.equals("II")) {
                    ...
                    lista.insertStart(listaInicial.cloneById(id));
                    ...
                    id = Integer.parseInt(temp);
                    lista.insertMiddle(listaInicial.cloneById(id), pos);
                    ...
                    id = Integer.parseInt(temp);
                    lista.insertEnd(listaInicial.cloneById(id));
