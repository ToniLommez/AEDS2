...
public class Questao_1 {
    ...
    public static void matriculaarvoreBinaria(long tempo, int comparacoes) {
        try {
            Formatter file = new Formatter("matricula_arvoreBinaria.txt");
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; populacao[i] != null; i++) {
            ab.inserir(encontrarGame(Integer.parseInt(populacao[i]), arrayGames));
        }
        ...
        for (int i = 0; comandos[i] != null; i++) {
            if (comandos[i].charAt(0) == 'I') {
                ab.inserir(encontrarGame(Integer.parseInt(comandos[i].substring(2)), arrayGames));
            } else if (comandos[i].charAt(0) == 'R') {
                ab.remover(comandos[i].substring(2));
            }
        }
        ...
        matriculaarvoreBinaria(tempo, ab.getComparacoes());
    }
}
